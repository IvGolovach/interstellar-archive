...
- Added strict CI guard `scripts/ci/version_contract_validate.py --strict`.
- Synchronized release metadata: `VERSION`, `CITATION.cff`, and `artifacts/research_signals.json`.
- Normalized release reporting to keep SemVer releases separate from research notes.

### v0.2.0

#### Added
- Formal Objective Function Contract v1
- Deterministic Risk Envelope v1
- 2D Pareto Frontier (realistic mode)
- Failure Surface & Breakdown UX
- Data-driven Visualization Layer (2D)

#### Checks
- sim/** unchanged
- Golden checksum unchanged
- Registry traceability complete
- Deterministic optimization and frontier artifacts

### v0.1.0
- Initial reproducible research baseline.
