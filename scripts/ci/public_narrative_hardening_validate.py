#!/usr/bin/env python3
"""Validate the Public Narrative Hardening artifact."""
...
from mission.narrative import validate_public_narrative_hardening


DEFAULT_ARTIFACT = Path("artifacts/public_narrative_hardening.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: public narrative hardening validation")
