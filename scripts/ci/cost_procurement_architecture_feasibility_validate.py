#!/usr/bin/env python3
"""Validate the Cost/Procurement/Architecture Feasibility artifact."""
...
from mission.architecture import validate_cost_procurement_architecture_feasibility


DEFAULT_ARTIFACT = Path("artifacts/cost_procurement_architecture_feasibility.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: cost/procurement/architecture feasibility validation")
