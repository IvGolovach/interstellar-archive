#!/usr/bin/env python3
"""Validate the Uncertainty Interactions artifact."""
...
from mission.uncertainty import validate_uncertainty_interactions


DEFAULT_ARTIFACT = Path("artifacts/uncertainty_interactions.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: uncertainty interactions validation")
