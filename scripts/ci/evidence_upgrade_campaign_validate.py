#!/usr/bin/env python3
"""Validate the Evidence Upgrade Campaign artifact."""
...
from mission.evidence_upgrade import validate_evidence_upgrade_campaign


DEFAULT_ARTIFACT = Path("artifacts/evidence_upgrade_campaign.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: evidence upgrade campaign validation")
