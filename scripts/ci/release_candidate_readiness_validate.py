#!/usr/bin/env python3
"""Validate the Release Candidate Readiness artifact."""
...
from mission.external_proof import validate_release_candidate_readiness


DEFAULT_ARTIFACT = Path("artifacts/release_candidate_readiness.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: release candidate readiness validation")
