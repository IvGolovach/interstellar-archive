#!/usr/bin/env python3
"""Validate the External Reproduction Kit artifact."""
...
from mission.external_reproduction import validate_external_reproduction_kit


DEFAULT_ARTIFACT = Path("artifacts/external_reproduction_kit.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: external reproduction kit validation")
