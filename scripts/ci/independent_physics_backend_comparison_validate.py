#!/usr/bin/env python3
"""Validate the Independent Physics Backend Comparison artifact."""
...
from mission.external_proof import validate_independent_physics_backend_comparison


DEFAULT_ARTIFACT = Path("artifacts/independent_physics_backend_comparison.v1.json")
...
def main() -> int:
    ...
    if args.format == "json":
        ...
        print(f"{result['status']}: independent physics backend comparison validation")
